...
def run_gof_beta(data_input, class_edges, alpha: float = 0.05, lang: str = "en") -> dict:
    """
    Tests whether data on [0, 1] follow a Beta(a, b) distribution, with
    shape parameters a and b estimated by the method of moments:
