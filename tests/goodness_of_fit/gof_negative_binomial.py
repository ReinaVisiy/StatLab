...
def run_gof_negative_binomial(data_input, r: int, alpha: float = 0.05, lang: str = "en") -> dict:
    """
    ...
    by the user; p is estimated from the sample mean via method of moments:
    mean = r(1-p)/p  =>  p\u0302 = r / (r + mean).
